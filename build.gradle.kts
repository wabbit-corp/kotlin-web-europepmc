...
// managed-integrity-v1: bsBVULuNmUG
//
...
mavenPublishing {
    coordinates("one.wabbit", "kotlin-web-europepmc", project.version.toString())
    publishToMavenCentral()
    signAllPublications()
    pom {
        name.set("kotlin-web-europepmc")
        description.set("kotlin-web-europepmc")
        url.set("https://github.com/wabbit-corp/kotlin-web-europepmc")
        licenses {
            license {
        ...
        scm {
            url.set("https://github.com/wabbit-corp/kotlin-web-europepmc")
            connection.set("scm:git:git://github.com/wabbit-corp/kotlin-web-europepmc.git")
            developerConnection.set("scm:git:ssh://git@github.com/wabbit-corp/kotlin-web-europepmc.git")
        }
    }
}
...
publishing {
    publications.withType<org.gradle.api.publish.maven.MavenPublication>().configureEach {
        val configuredArtifactId = "kotlin-web-europepmc"
...
kotlin {
    ...
    androidLibrary {
        namespace = "one.wabbit.web.europepmc"
        compileSdk = 34
        minSdk = 26
    }
        ...
        extensions.findByType(DokkaExtension::class)?.apply {
            ...
            dokkaSourceSets.configureEach {
                ...
                sourceLink {
                    ...
                    remoteUrl("https://github.com/wabbit-corp/kotlin-web-europepmc/tree/master/src")
