...
publishing {
    publications {
        create<MavenPublication>("maven") {
            groupId = "one.wabbit"
            artifactId = "kotlin-web-europepmc"
            version = "2.0.0"
...
kover {
    ...
    //             // title.set("kotlin-web-europepmc Code Coverage") // Uncomment to customize title
    //         }
    //         xml {
...
dokka {
    moduleName.set("kotlin-web-europepmc")
    ...
    dokkaSourceSets.main {
        ...
        sourceLink {
            ...
            remoteUrl("https://github.com/wabbit-corp/kotlin-web-europepmc/tree/master/src/main/kotlin")
